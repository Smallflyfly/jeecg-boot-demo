...
<head>
    ...
    <script language="javascript" type="text/javascript"
            src="${base}/bigscreen/template1/js/jquery.easyui.min.js"></script>
    <script language="javascript" type="text/javascript" src="${base}/bigscreen/template1/js/echarts.min.js"></script>
    <script language="javascript" type="text/javascript"
            src="${base}/bigscreen/template1/js/echarts-wordcloud.js"></script>
...
<div id="modalDlg" class="easyui-dialog" title="弹出窗口" data-options="modal:true,closed:true,buttons:
    ...
    <table width="100%" cellpadding="5">
        ...
        <tr>
            ...
            <td>
                <input type="radio" name="updateUserStatus" id="updateUserStatus1" value="0"><label
                        for="updateUserStatus1">启用</label>&nbsp;&nbsp;
                <input type="radio" name="updateUserStatus" id="updateUserStatus2" value="1"><label
                        for="updateUserStatus2">禁用</label>
            </td>
        </tr>
        <tr>
