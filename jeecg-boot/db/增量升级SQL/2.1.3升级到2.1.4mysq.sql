...
VALUES ('1209779538310004737', 'MySQL5.7', '本地数据库MySQL5.7', '1', 'com.mysql.jdbc.Driver',
...
INSERT INTO `sys_dict_item` (`id`, `dict_id`, `item_text`, `item_value`, `description`, `sort_order`, `status`,
                             `create_by`, `create_time`, `update_by`, `update_time`)
VALUES ('1209733903020003330', '1209733563293962241', 'SQLServer', '3', '', '1', '1', 'admin', '2019-12-25 15:13:33',
        NULL, NULL);


-- 生产销售监控 --
update sys_permission
set url='{{ window._CONFIG[\'domianURL\'] }}/big/screen/templat/index1'
where id = '1205098241075453953';
-- 智慧物流监控 --
update sys_permission
set url='{{ window._CONFIG[\'domianURL\'] }}/big/screen/templat/index2'
where id = '1205306106780364802';
...
INSERT INTO `sys_permission` (`id`, `parent_id`, `name`, `url`, `component`, `is_route`, `component_name`, `redirect`,
                              `menu_type`, `perms`, `perms_type`, `sort_no`, `always_show`, `icon`, `is_leaf`,
                              `keep_alive`, `hidden`, `description`, `create_by`, `create_time`, `update_by`,
                              `update_time`, `del_flag`, `rule_flag`, `status`, `internal_or_external`)
VALUES ('1209731624921534465', 'd7d6e2e4e2934f2c9385a623fd98c6f3', '多数据源管理', '/isystem/dataSource',
        'system/SysDataSourceList', '1', NULL, NULL, '1', NULL, '1', '3', '0', NULL, '1', '0', '0', NULL, 'admin',
        '2019-12-25 15:04:30', NULL, NULL, '0', '0', '1', '0');
...
INSERT INTO `sys_permission` (`id`, `parent_id`, `name`, `url`, `component`, `is_route`, `component_name`, `redirect`,
                              ...
                              `keep_alive`, `hidden`, `description`, `create_by`, `create_time`, `update_by`,
                              `update_time`, `del_flag`, `rule_flag`, `status`, `internal_or_external`)
VALUES ('1224641973866467330', 'd7d6e2e4e2934f2c9385a623fd98c6f3', '编码校验规则', '/isystem/checkRule',
        'system/SysCheckRuleList', '1', NULL, NULL, '1', NULL, '1', '2', '0', NULL, '1', '0', '0', NULL, 'admin',
        '2019-11-07 13:52:53', NULL, NULL, '0', '0', '1', '0');
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='部门权限表';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='部门角色表';
...
(
  ...
  ROW_FORMAT = COMPACT COMMENT ='部门角色权限表';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='部门角色用户表';
